...
class FillPermissionsForFilliere extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFilliere constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.filliere',
            'admin.filliere.index',
            'admin.filliere.create',
            'admin.filliere.show',
            'admin.filliere.edit',
            'admin.filliere.delete',
            'admin.filliere.bulk-delete',
        ]);
