...
class FillPermissionsForEtudiant extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEtudiant constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.etudiant',
            'admin.etudiant.index',
            'admin.etudiant.create',
            'admin.etudiant.show',
            'admin.etudiant.edit',
            'admin.etudiant.delete',
            'admin.etudiant.bulk-delete',
        ]);
