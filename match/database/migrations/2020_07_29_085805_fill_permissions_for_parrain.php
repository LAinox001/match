...
class FillPermissionsForParrain extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForParrain constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.parrain',
            'admin.parrain.index',
            'admin.parrain.create',
            'admin.parrain.show',
            'admin.parrain.edit',
            'admin.parrain.delete',
            'admin.parrain.bulk-delete',
        ]);
