...
class FillPermissionsForCouleur extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCouleur constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.couleur',
            'admin.couleur.index',
            'admin.couleur.create',
            'admin.couleur.show',
            'admin.couleur.edit',
            'admin.couleur.delete',
            'admin.couleur.bulk-delete',
        ]);
